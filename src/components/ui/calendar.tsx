...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("w-[15rem]", defaultClassNames.root),
        months: cn(
          "flex gap-4 flex-col md:flex-row relative",
          defaultClassNames.months,
        ),
        month: cn(
          "flex flex-col w-full gap-4 min-h-[16rem]",
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <Icon name="MdChevronLeft" className="cursor-pointer text-2xl" />
            );
          }
          if (orientation === "right") {
            return (
              <Icon name="MdChevronRight" className="cursor-pointer text-2xl" />
            );
          }
          return (
            <Icon
