...
export default function ifleInscriptionAttestationFRPDF({
  ...
  const exportToPDF = async () => {
    try {
      ...
      const fileName = `Transcript T${studentNotesData.CourseNotes[studentNotesData.CourseNotes.length - 1].Quarter} ${studentNotesData.CourseNotes[studentNotesData.CourseNotes.length - 1].ScholarYear}  ${studentName}`;
